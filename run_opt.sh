...
PYTHONPATH="$PWD/configs:$PWD/build/X86_LC_MSI/python" ./build/X86_LC_MSI/gem5.opt --debug-flags=ZIVCache --debug-file=ziv.log --debug-start=0 \
    configs/xyz/simple_ruby.py --wc --subslot-opt --ncore 4 --use-ziv --use-vi --l1-assoc 2 --l2-assoc 4 --l3-assoc 8 \
...
# PYTHONPATH="$PWD/configs:$PWD/build/X86_LC_MSI/python" ./build/X86_LC_MSI/gem5.opt --debug-flags=ZIVCache --debug-file=ziv.log --debug-start=0 \
#     configs/xyz/simple_ruby.py --wc --subslot-opt --ncore 4 --wc --use-ziv --use-vi --l1-assoc 2 --l2-assoc 4 --l3-assoc 8 \
...
# PYTHONPATH="$PWD/configs:$PWD/build/X86_LC_MSI/python" ./build/X86_LC_MSI/gem5.opt --debug-flags=ZIVCache --debug-file=ziv.log --debug-start=0 \
#     configs/xyz/simple_ruby.py --wc --subslot-opt --ruby-test --ncore 4 --use-ziv --use-vi --l1-assoc 2 --l2-assoc 4 --l3-assoc 8 \
#     --nreq 20000